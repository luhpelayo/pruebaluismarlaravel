            ...
            <div class="testimonial_carosel">
                <div class="item">
                    <div class="media">
                        <div class="media-left">
                            <a href="#">
                                <img class="media-object" src="{{ asset('images/perfil/director.png')}}" alt="">
                            </a>
                        </div>
                        <div class="media-body">
                            <h4 class="media-heading">MSc. Ruddy Sanguino Suárez</h4>
                            <h6>DIRECTOR DE CARRERA</h6>
                        </div>
                    </div>
                ...
                <div class="item">
                    <div class="media">
                        <div class="media-left">
                            <a href="#">
                                <img class="media-object" src="{{ asset('images/images/testimonial-3.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="media-body">
                ...
                <div class="item">
                    <div class="media">
                        <div class="media-left">
                            <a href="#">
                                <img class="media-object" src="{{ asset('images/images/testimonial-1.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="media-body">
                ...
                <div class="item">
                    <div class="media">
                        <div class="media-left">
                            <a href="#">
                                <img class="media-object" src="{{ asset('images/images/testimonial-2.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="media-body">
