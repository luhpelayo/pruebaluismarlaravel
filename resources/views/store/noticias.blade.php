			...
			@if(isset($noticias) && count($noticias) > 0)
				@foreach ($noticias as $noticia)
					<div class="col-xs-12 col-sm-12">
						<div class="panel panel-default resizable-col-events" style="text-align: center">
						  	<div class="panel-body resizable-panel">
									@if(isset($noticia->url_img))
						    		<img style=" display: block; margin-left: auto; margin-right: auto;" class="img-responsive " src="images/noticias/{{$noticia->url_img}}">
									@endif
						    	<br>
						    	<h3>{{ $noticia->title }}</h3>
